...
load data infile 'D:/Intro_Database_System/data_reform/Stock.csv' into table Stock
fields terminated by ',' 
optionally enclosed by '"' 
escaped by '"' 
lines terminated by '\r\n';

load data infile 'D:/Intro_Database_System/data_reform/Conference.csv' into table Conference
fields terminated by ',' 
optionally enclosed by '"' 
escaped by '"' 
lines terminated by '\r\n';

load data infile 'D:/Intro_Database_System/data_reform/Finance1.csv' into table Finance1
fields terminated by ',' 
optionally enclosed by '"' 
escaped by '"' 
lines terminated by '\r\n';

load data infile 'D:/Intro_Database_System/data_reform/Finance2.csv' into table Finance2
fields terminated by ',' 
optionally enclosed by '"' 
escaped by '"' 
lines terminated by '\r\n';

load data infile 'D:/Intro_Database_System/data_reform/Shareholder.csv' into table Shareholder
fields terminated by ',' 
optionally enclosed by '"' 
escaped by '"' 
lines terminated by '\r\n';

load data infile 'D:/Intro_Database_System/data_reform/Transact.csv' into table Transact
fields terminated by ',' 
optionally enclosed by '"' 
escaped by '"' 
lines terminated by '\r\n';

load data infile 'D:/Intro_Database_System/data_reform/LawCase.csv' into table LawCase
fields terminated by ',' 
optionally enclosed by '"' 
escaped by '"' 
lines terminated by '\r\n';
